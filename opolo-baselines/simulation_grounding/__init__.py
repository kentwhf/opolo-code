...
register(
    ...
    entry_point='simulation_grounding.envs.mujoco:InvertedPendulumModifiedEnv',
...
register(
    ...
    entry_point='simulation_grounding.envs.mujoco:HopperModifiedEnv',
    max_episode_steps=1000,
...
register(
    ...
    entry_point='simulation_grounding.envs:HopperGravityModifiedEnv',
    max_episode_steps=1000,
    reward_threshold=3800.0,
    )
...
register(
    ...
    entry_point='simulation_grounding.envs.mujoco:HopperFrictionModifiedEnv',
    max_episode_steps=1000,
    reward_threshold=3800.0,
    )
...
register(
    ...
    entry_point='simulation_grounding.envs.mujoco:HalfCheetahSafeEnv',
    max_episode_steps=1000,
...
register(
    ...
    entry_point='simulation_grounding.envs.mujoco:HalfCheetahSafeModifiedEnv',
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
...
register(
    ...
    entry_point='simulation_grounding.envs.mujoco:Walker2dModifiedEnv',
    max_episode_steps=1000,
)
