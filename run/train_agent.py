...
if __name__ == '__main__':
    ...
    parser.add_argument('--n-episodes', help='Number of expert episodes', type=int, default=4)
    ...
    expert_dataset = ExpertDataset(expert_path=data_save_dir, ob_flatten=False)
    ...
    ##############################################################
    cb_func = a2c_callback(args.log_dir, args.task) #<-------------------------------- DELETED 2021.03.11
    # cb_func = None #<-------------------------------- ADDED 2021.03.11
